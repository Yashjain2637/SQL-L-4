...
-- A Common Table Expression (CTE) in SQL is a temporary, named result set that can
-- be referenced within a single SQL statement. It acts like a temporary view, existing only
-- for the duration of the main query's execution, improving readability and maintainability of
-- complex SQL code.
-- SYNTAX :-
...
-- the quary in collumns is the cte 
