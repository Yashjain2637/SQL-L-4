...
select s.student_id , s.student_name ,e.enrollment_id,e.course_name,e.student_id from students as s inner join enrollments as e
on s.student_id = e.student_id;

-- select all students 
select s.student_id , s.student_name ,e.enrollment_id,e.course_name,e.student_id
from students as s left join enrollments as e
on s.student_id = e.student_id;


-- all enrollments even if the students are missing
select s.student_id , s.student_name ,e.enrollment_id,e.course_name,e.student_id
from students as s right join enrollments as e
on s.student_id = e.student_id;

-- vo hi student ka data nikalna hain jisme enrollment_id null ho 
select s.student_id , s.student_name ,e.enrollment_id,e.course_name,e.student_id
from students as s left join enrollments as e
on s.student_id = e.student_id where enrollment_id is null;

-- har ek student ke total courses nikalne hain 
...
-- har ek student ke liye total credits nikalne hain 
select s.student_id , s.student_name ,sum(e.credits)
from students as s left join enrollments as e
on s.student_id = e.student_id group by s.student_id;

-- vo students nikalne hain jisne 2 se jyda course liye hain 
select s.student_id , s.student_name ,count(e.enrollment_id)
from students as s left join enrollments as e
on s.student_id = e.student_id group by s.student_id having count(e.enrollment_id)>2;

select s.student_id , s.student_name ,count(e.enrollment_id)
from students as s left join enrollments as e
on s.student_id = e.student_id group by s.student_id order by count(e.enrollment_id) desc limit 5 offset 2;
