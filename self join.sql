...
from employee as emp join employee as mngr
where emp.manager_id=mngr.emp_id;

-- you need to find out how many employye for each manager :- 

select mngr.emp_name ,count(emp.emp_id) from employee as emp join employee as mngr
